...
public class PembayaranGaji extends Abstract{
    ...
    // Konstruktor untuk membuat objek PembayaranGaji
    // Overloaded konstruktor
//    public PembayaranGaji(String idKaryawan, String namaKaryawan, String jabatan, int gajiPokok, int tunjangan, int pajak, int totalGaji, String metodePembayaran) {
//        this.idKaryawan = idKaryawan;
//        this.namaKaryawan = namaKaryawan;
//        this.jabatan = jabatan;
//        this.gajiPokok = gajiPokok;
